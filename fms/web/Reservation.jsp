                ...
                <div class="nav-menu">
                    <nav class="mainmenu mobile-menu">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="Reservation.jsp">Reservations</a></li>
                    ...
                    <form action="addReservationServlet">
                        <div class="row">
                            ...
                            <div class="input-group col-lg-12 mb-4">
                                ...
                                <input id="rdate" type="date" name="reservationdate" placeholder="Reservation Date" class="form-control bg-white border-left-0 border-md">
                            </div>
                            ...
                            <div class="input-group col-lg-12 mb-4">
                                ...
                                <input id="rtime" type="time" name="reservationtime" placeholder="Reservation Time" class="form-control bg-white border-left-0 border-md">
                            </div>
                             ...
                             <div class="input-group col-lg-12 mb-4">
                                ...
                                <input id="ruserid" type="number" name="reservationuserid" placeholder="Reservation User Id" class="form-control bg-white border-left-0 border-md">
                            </div>
                            ...
                            <div class="input-group col-lg-12 mb-4">
                                ...
                                <input id="rusername" type="text" name="reservationusername" placeholder="User Name" class="form-control bg-white border-left-0 border-md">
                            </div>
                            ...
                            <div class="input-group col-lg-12 mb-4">
                                ...
                                <input id="rdetai" type="text" name="reservationdetail" placeholder="Details" class="form-control bg-white border-left-0 border-md">
                            </div>
