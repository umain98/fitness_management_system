        ...
        <section class="about-section about-page spad">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-pic">
                            <iframe width="560" height="320" src="https://www.youtube.com/embed/wnHW6o8WMas?start=4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    ...
                    <div class="col-lg-6">
                        <div class="about-text">
                            ...
                            <div class="at-author">
                                <h4>Ajantha Fernando</h4>
                                <span>CEO - Life Fitness</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-trainer-item">
                            <img src="img/trainer/umi.jpg" alt="">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-trainer-item">
                            <img src="img/trainer/nimna.jpg" alt="">
                            <div class="trainer-text">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-trainer-item">
                            <img src="img/trainer/bhanu.jpg" alt="">
                            <div class="trainer-text">
