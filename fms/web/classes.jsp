...
<html>
    ...
    <body>
                ...
                <div class="nav-menu">
                    <nav class="mainmenu mobile-menu">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="classes.jsp">Classes</a></li>
        ...
        <section class="breadcrumb-section set-bg" data-setbg="img/breadcrumb/cover.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-class-item set-bg" data-setbg="img/classes/classes-1.jpg">
                            <div class="si-text">
                                <h4>Yoga Class</h4>
                                <span><i class="fa fa-user"></i>Miss Ambegoda</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-class-item set-bg" data-setbg="img/classes/classes-8.jpg">
                            <div class="si-text">
                                <h4>Cycling</h4>
                                <span><i class="fa fa-user"></i> Mr.Thushara Dilshan</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="nav-controls">
                            <ul>
                                ...
                                <li data-tsfilter="weights">Weights</li>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="hover-bg ts-item" data-tsmeta="weights">
                                            <h6>Weights</h6>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td class="hover-bg ts-item"data-tsmeta="zumba">
                                            <h6>Zumba</h6>
