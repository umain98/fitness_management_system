...
public class deleteOrderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = Validations.getIntOrZeroFromString(ses.getAttribute("delete_order_id").toString());

        try {
            OrderControlller.deleteOrderById(id);
            response.sendRedirect("dashboard_products_orders.jsp");
