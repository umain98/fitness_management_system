 ...
 * @author USER
 */
@WebServlet(name = "addOrderDetailServlet", urlPatterns = {"/addOrderDetailServlet"})
public class addOrderDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String detailsPrice = request.getParameter("txtDetailsPrice");
        String discountAmount = request.getParameter("txtDiscountAmount");
        String discountedPrice = request.getParameter("txtDiscountedPrice");
